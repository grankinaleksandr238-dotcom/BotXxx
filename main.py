...
# Все ошибки, связанные с фильтрацией событий и FSM, устранены.
# Полностью совместимо с aiogram 3.x.
...
@dp.message(state="edit_giveaway_field", F.text)
...
@dp.message(state="edit_giveaway_prize", F.text)
...
@dp.message(state="edit_giveaway_description", F.text)
...
@dp.message(state="edit_giveaway_end_date", F.text)
...
@dp.message(state="edit_giveaway_min_participants", F.text)
...
@dp.message(state="edit_giveaway_winners_count", F.text)
...
@dp.message(state="edit_giveaway_media", F.photo | F.text)
